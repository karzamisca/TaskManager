  ...
  try {
    ...
    const docDefinition = {
      ...
      content: [
            ...
            body: [
              ...
              ...records.map((record, index) => {
                ...
                const baseRow = [
                  ...
                  {
                    text: Math.ceil(record.currentSalary).toLocaleString(
                      "vi-VN"
                    ),
                    style: "tableContent",
                    alignment: "right",
        ...
        // Summary section for yearly report
        ...(month
          ? []
          : [
              {
                text: [
                  ...
                  {
                    text: `Tổng lương gộp: ${totalGross.toLocaleString(
                      "vi-VN"
                    )} VND`,
                    style: "summaryText",
                  },
...
exports.exportSalaryPaymentExcel = async (req, res) => {
  try {
    ...
    if (!month) {
      ...
      const summaryHeaderCell = summaryRow.getCell(1);
