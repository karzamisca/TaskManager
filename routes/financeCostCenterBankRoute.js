...
// POST regenerate loan entries
router.post(
  "/financeCostCenterBankControl/:costCenterId/regenerate-loans",
  regenerateLoanEntries,
);

// POST preview loan schedule
router.post(
  "/financeCostCenterBankControl/preview-loan-schedule",
  previewLoanSchedule,
);
